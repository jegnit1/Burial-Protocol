...
func _build_attack_module_item_definition(row: Dictionary, errors: Array[String]):
	...
	definition.apply_dictionary({
		...
		"equipment_category": _validation.get_required_string(row, "equipment_category", TSV_SCHEMA.ATTACK_MODULE_ITEMS_FILE, errors),
		"attribute": _validation.get_required_string(row, "attribute", TSV_SCHEMA.ATTACK_MODULE_ITEMS_FILE, errors),
		"attack_type": _validation.get_required_string(row, "attack_type", TSV_SCHEMA.ATTACK_MODULE_ITEMS_FILE, errors),
		...
		"weapon_base_cooldown": _validation.get_optional_float(row, "weapon_base_cooldown", 0.0),
		"protocol_base_damage": _validation.get_optional_int(row, "protocol_base_damage", 0),
		"protocol_base_cooldown": _validation.get_optional_float(row, "protocol_base_cooldown", 0.0),
		"protocol_behavior": _validation.get_optional_string(row, "protocol_behavior"),
		"targeting": _validation.get_optional_string(row, "targeting"),
		...
		"stagger_power": _validation.get_optional_float(row, "stagger_power", 0.0),
...
func _build_effect_item_definition(row: Dictionary, errors: Array[String]):
	...
	var definition_data := {
		...
		"equipment_category": _validation.get_required_string(row, "equipment_category", file_label, errors),
		"attribute": _validation.get_required_string(row, "attribute", file_label, errors),
		"attack_type": _validation.get_required_string(row, "attack_type", file_label, errors),
		"allowed_weapon_ids": Array(_validation.get_string_list(row, "allowed_weapon_ids")),
		"allowed_weapon_types": Array(_validation.get_string_list(row, "allowed_weapon_types")),
		"allowed_attack_styles": Array(_validation.get_string_list(row, "allowed_attack_styles")),
		"exclusive_group": _validation.get_optional_string(row, "exclusive_group"),
		"icon_path": _validation.get_optional_string(row, "icon_path"),
